...
annot = open(r'C:\Users\77ana\PycharmProjects\ocr\content\Data-generator-for-CRNN\annotation.txt', 'r').readlines()
imagenames = []
txts = []
...
for i in range(len(imagenames)):
    img = cv2.imread('C:/Users/77ana/PycharmProjects/ocr/content/Data-generator-for-CRNN/images/' + imagenames[i], 0)
...
filepath = "C:/Users/77ana/PycharmProjects/ocr/content/best_model.hdf5"
...
act_model.load_weights('C:/Users/77ana/PycharmProjects/ocr/content/best_model.hdf5')
