...
#  input_width=320)
model = unet()
# model.load_weights('WS_weights00000003.h5')
# model.summary()
...
mc = ModelCheckpoint('WS_weights00000001.h5',
                     save_weights_only=True, period=1)
model.fit_generator(batch_generator(file_train, 2, 2), epochs=1, steps_per_epoch=1000,
